                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-3">
                                    <button type="button"
                                        class="btn bg-orange-alt text-white btn-progress">Detalles</button>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-12 row padd-0 m-nv-nm">
                                    <div class="col-12 col-md-6 padd-0">
                                        ...
                                        <h1 class="mb-0 p-blue">
                                            <sup>$</sup>{{number_format($total_ventas['nivel1'], 1, ',', '.')}}<sup>USD</sup>
                                            <p class="p-blue text-ventas">Ventas</p>
                                        </h1>
                                    </div>
                                    <div class="col-12 col-md-6 padd-0">
                                        <h1 class="mb-0 fl-right p-blue">
                                            <sup>$</sup>{{number_format($total_comision['nivel1'], 1, ',', '.')}}<sup>USD</sup>
                            ...
                            <div class="card-header card-nivel">
                                ...
                                <div class="col-12 row padd-0 m-nv-nm">
                                    <div class="col-12 col-md-6 padd-0">
                                        ...
                                        <h1 class="mb-0 p-blue">
                                            <sup>$</sup>{{number_format($total_ventas['nivel2'], 1, ',', '.')}}<sup>USD</sup>
                                            <p class="p-blue text-ventas">Ventas</p>
                                        </h1>
                                    </div>
                                    <div class="col-12 col-md-6 padd-0">
                                        <h1 class="mb-0 fl-right p-blue">
                                            <sup>$</sup>{{number_format($total_comision['nivel2'], 1, ',', '.')}}<sup>USD</sup>
                                            <p class="p-blue text-ventas">Comisión</p>
                                        </h1>
                                    </div>
                                </div>
                            ...
                            <div class="card-header card-nivel">
                                ...
                                <div class="col-12 row padd-0 m-nv-nm">
                                    <div class="col-12 col-md-6 padd-0">
                                        ...
                                        <h1 class="mb-0 p-blue">
                                            <sup>$</sup>{{number_format($total_ventas['nivel3'], 1, ',', '.')}}<sup>USD</sup>
                                            <p class="p-blue text-ventas">Ventas</p>
                                        </h1>
                                    </div>
                                    <div class="col-12 col-md-6 padd-0">
                                        <h1 class="mb-0 fl-right p-blue">
                                            <sup>$</sup>{{number_format($total_comision['nivel3'], 1, ',', '.')}}<sup>USD</sup>
                                            <p class="p-blue text-ventas">Comisión</p>
                                        </h1>
                                    </div>
                                </div>
                            ...
                            <div class="card-header card-nivel">
                                ...
                                <div class="col-12 row padd-0 m-nv-nm">
                                    <div class="col-12 col-md-6 padd-0">
                                        ...
                                        <h1 class="mb-0 p-blue">
                                            <sup>$</sup>{{number_format($total_ventas['nivel4'], 1, ',', '.')}}<sup>USD</sup>
                                            <p class="p-blue text-ventas">Ventas</p>
                                        </h1>
                                    </div>
                                    <div class="col-12 col-md-6 padd-0">
                                        <h1 class="mb-0 fl-right p-blue">
                                            <sup>$</sup>{{number_format($total_comision['nivel4'], 1, ',', '.')}}<sup>USD</sup>
                                            <p class="p-blue text-ventas">Comisión</p>
                                        </h1>
                                    </div>
                                </div>
