...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'licencia', 'guest', 'profile.status']], function() {
  ...
  // Fichass
    Route::group(['prefix' => 'fichas'], function(){
      Route::get('/', 'FichasController@fichasAsignar')->name('admin.ficha');
      Route::get('/base/{id}', 'FichasController@insertarBase')->name('admin.ficha.base');
      Route::get('automatico/{id}', 'FichasController@insetarAutomaticamente')->name('admin.ficha.automatica');
      Route::get('/posicion/{idposicion}/{idficha}', 'FichasController@insertarFicha')->name('admin.ficha.posicion');
    });
